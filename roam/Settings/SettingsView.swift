    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("Free accounts can create up to \(AppServices.freeTripLimit) trips.")
            }
            ...
            Section("About") {
                ...
                Link("Support", destination: URL(string: "https://roam.club/support")!)
                Link("Privacy Policy", destination: URL(string: "https://roam.club/privacy")!)
            }
        }
        ...
        .alert("Sign out of roam?", isPresented: $showSignOutConfirm) {
            Button("Sign out", role: .destructive) {
                Task { await services.auth.signOut() }
            }
            Button("Cancel", role: .cancel) {}
        }
        .alert("Delete your roam account?", isPresented: $showDeleteConfirm) {
            Button("Continue", role: .destructive) {
                showFinalDeleteConfirm = true
            }
            Button("Cancel", role: .cancel) {}
        } message: {
            Text("This permanently removes your trips, itinerary items, devices, subscription mirror, and profile. This cannot be undone.")
        }
